      ...
      <div
        ...
        style={{
          background: mounted && theme === 'dark'
            ? 'linear-gradient(to bottom, #020612 0%, rgba(2, 6, 18, 0.8) 50%, rgba(2, 6, 18, 0) 100%)'
            : 'linear-gradient(to bottom, #f0eeea 0%, rgba(240, 238, 234, 0.8) 50%, rgba(240, 238, 234, 0) 100%)'
        }}
      />

      <div className="relative mx-auto flex max-w-7xl items-center justify-center px-4 py-6 sm:px-6 lg:px-8">
        {/* Titre centré - text-base (16px) */}
        <h1 className="pointer-events-auto flex items-center gap-2 font-bold uppercase leading-none tracking-tight text-base">
          <span>Thomas</span>
          <span>Giberné</span>
        </h1>
